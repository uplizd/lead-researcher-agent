  ...
  return (
    <div className="chat">
      <header className="chat-header">
        <div className="chat-header-title">Playground</div>
        <p className="chat-header-desc">
          Describe ICP criteria (industry, headcount, titles, geography, tech stack). The
          UPLIZD flow runs Apollo, web search, and HubSpot via Composio to build enriched
          prospect lists.
        </p>
      </header>
        ...
        {isEmpty ? (
          <div className="chat-empty">
            ...
            <p className="chat-empty-text">
              Paste ICP fields or use a quick prompt. Shift+Enter adds a new line.
            </p>
          </div>
        ) : (
          <>
      ...
      <div className="chat-composer">
        <div className="chat-composer-inner">
          <textarea
            ...
            onKeyDown={handleKey}
            placeholder="e.g. Industry, company size, titles, region, tech stack — or paste ICP notes…"
            rows={1}
